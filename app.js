...
const itinerary = [
  {day:1,date:"Sat, Jul 18",route:"LAX → LA icons → Malibu → Ventura",sleep:"Four Points by Sheraton Ventura Harbor Resort",stops:[
    stop("d1-1","10:00 AM","Arrive LAX","ORD → LAX, then pick up rental car","LAX",["Flight","Rental car"]),
    stop("d1-2","11:45 AM","Hollywood Walk of Fame ⭐","TCL Chinese Theatre and Dolby Theatre. Keep it tight — this is not a full Hollywood afternoon.","Hollywood Walk of Fame",["Kids wish list"]),
    stop("d1-3","1:15 PM","Griffith Observatory 📸","Best easy view of the Hollywood Sign","Griffith Observatory",["Hollywood Sign"]),
    stop("d1-4","2:45 PM","Beverly Hills / Rodeo Drive","Beverly Hills sign, Rodeo Drive, quick photo stop","Beverly Hills Sign",["30–45 min"]),
    stop("d1-5","3:45 PM","Erewhon Santa Monica 🥤","Hailey Bieber smoothie and snack before leaving LA","Erewhon Santa Monica",["Kids wish list"]),
    stop("d1-6","4:30 PM","Malibu / PCH scenic drive 🌊","Coastal drive toward Ventura. One quick stop only if parking is easy.","El Matador State Beach",["Coast","Drive"]),
    stop("d1-7","6:30–7:30 PM","Check in: Four Points Ventura Harbor","Booked via Marriott Bonvoy. Confirmation #75176420. Guest room with 2 queens.","Four Points by Sheraton Ventura Harbor Resort",["Sleep","Booked","Marriott"])
  ]},
  {day:2,date:"Sun, Jul 19",route:"Ventura → Santa Barbara → Solvang → Pismo",sleep:"Pismo / Central Coast — not locked yet",stops:[
    stop("d2-1","8:30 AM","Breakfast / check out Ventura","Slow start, but do not waste the morning. This is still a movement day.","Four Points by Sheraton Ventura Harbor Resort",[]),
    stop("d2-2","10:00 AM","Santa Barbara stop","Stearns Wharf or State Street. Keep it focused, not a full city day.","Stearns Wharf",[]),
    stop("d2-3","12:00 PM PT / 2:00 PM CT","World Cup Final ⚽","Protect the match window. Watch in Santa Barbara, Solvang, or Pismo depending timing.","Santa Barbara sports bar",["Must do"]),
    stop("d2-4","After match","Solvang 🇩🇰","Danish bakeries, windmills, quick walk if energy allows","Solvang CA",["Optional"]),
    stop("d2-5","Optional","OstrichLand USA 🦩","Feed ostriches and emus if the day is still on track","OstrichLand USA",["Kids","Optional"]),
    stop("d2-6","Late afternoon","Drive to Pismo / Central Coast","Short final push. Hotel still being finalized.","Pismo Beach",["Drive"]),
    stop("d2-7","Evening","Pismo Pier sunset","Ice cream, beach, easy night","Pismo Pier",["Sleep"])
  ]},
  {day:3,date:"Mon, Jul 20",route:"Pismo → Big Sur → Monterey",sleep:"Monterey area — not locked yet",stops:[
    ...
    stop("d3-6","5:30 PM","Arrive Monterey","Dinner and check in. Monterey hotel still being finalized.","Monterey CA",["Sleep"])
  ]},
  {day:4,date:"Tue, Jul 21",route:"Monterey / Carmel",sleep:"Monterey / Sand City — not locked yet",stops:[
...
const dayReminders = {
  1: "Do not let LA steal the whole trip. Leave LA by 4:30 PM so Malibu/PCH and Ventura stay enjoyable.",
  2: "World Cup Final day. Protect the match window and keep Ventura → Santa Barbara → Pismo realistic.",
...
const dayBriefs = {
  1: {wake:"Naperville / ORD", sleep:"Ventura Harbor", drive:"4–5+ hrs total with LA traffic + Malibu/PCH", must:"Walk of Fame, Hollywood Sign, Erewhon, Malibu drive", leaveBy:"Leave LA by 4:30 PM", dinner:"Ventura Harbor / hotel-area dinner", warning:"This is the only LA day. Hit the icons, then get out toward the coast."},
  2: {wake:"Ventura", sleep:"Pismo / Central Coast", drive:"3.5–5 hrs total with Santa Barbara/Solvang stops", must:"World Cup Final + Pismo sunset", leaveBy:"Leave Santa Barbara area by late morning unless watching the match there", dinner:"Pismo Pier area", warning:"Protect the match window. Solvang/OstrichLand are optional if timing slips."},
  3: {wake:"Pismo / Central Coast", sleep:"Monterey area", drive:"5–6 hrs with Big Sur stops", must:"Elephant seals, McWay Falls, Bixby Bridge", leaveBy:"Leave Pismo by 8:30 AM", dinner:"Monterey / Cannery Row", warning:"Gas, snacks, bathrooms before Big Sur. Cell service gets spotty."},
  4: {wake:"Monterey", sleep:"Monterey / Sand City", drive:"Light local driving", must:"Monterey Bay Aquarium", leaveBy:"Be at Aquarium by 9:30 AM", dinner:"Carmel or Monterey", warning:"This can quietly become the hardest walking day. Control the wandering."},
...
const walkingLoads = {
  1: {level:"Medium/High", miles:"2–3.5 miles", note:"Airport logistics plus LA icons, Erewhon, and a Malibu stop. Lots of fragmented walking; keep stops tight."},
  2: {level:"Low/Medium", miles:"1–2 miles", note:"Mostly car-to-stop walking. Santa Barbara and Solvang can add up if we wander."},
  3: {level:"Low/Medium", miles:"1–2 miles", note:"Big Sur is mostly scenic pullouts and short overlooks. Driving fatigue is the bigger issue."},
  4: {level:"High", miles:"2.5–4 miles", note:"Aquarium standing/walking, Cannery Row, Carmel, and Lovers Point. This is the sneaky hard walking day."},
  5: {level:"Medium/High", miles:"2–4 miles", note:"Santa Cruz Boardwalk plus beach stops can add up quickly. Do not overstay Santa Cruz."},
  6: {level:"Medium/High", miles:"2.5–4 miles", note:"San Francisco hills, waterfront, Lombard, and city logistics. Use rideshare/transit when it saves legs."},
  7: {level:"High", miles:"3–5 miles", note:"Alcatraz has slopes and ramps, plus Pier 33/waterfront walking. Pace this day on purpose."},
  8: {level:"Low/Medium", miles:"1–2 miles", note:"Mostly hotel checkout, parking, rental return, and airport walking. Boring but still real steps."}
};

const stopWalking = {
  "d1-1":"Medium · airport + rental car logistics", "d1-2":"Medium · sidewalk crowds", "d1-3":"Medium · uphill/standing possible", "d1-4":"Low · quick photo/walk", "d1-5":"Low · store stop", "d1-6":"Low · drive-heavy, quick viewpoint only", "d1-7":"Low · hotel check-in",
  "d2-1":"Low · hotel logistics", "d2-2":"Medium · pier/State Street if wandering", "d2-3":"Low · seated match window", "d2-4":"Medium · town stroll", "d2-5":"Low/Medium · short attraction walk", "d2-6":"Low · drive", "d2-7":"Low/Medium · beach/pier stroll",
  "d3-1":"Low · driving day", "d3-2":"Low · short path from parking", "d3-3":"Low/Medium · viewpoint/lunch stop", "d3-4":"Medium · short overlook trail", "d3-5":"Low · photo stop", "d3-6":"Low · check-in",
  "d4-1":"High · standing-heavy aquarium", "d4-2":"Medium · Cannery Row wandering", "d4-3":"Low · mostly car viewpoints", "d4-4":"Medium/High · Carmel is walky/hilly", "d4-5":"Low/Medium · sunset stroll",
  "d5-1":"High · boardwalk and rides", "d5-2":"Medium · beach viewpoint", "d5-3":"Low · drive", "d5-4":"Low · quick photo stop", "d5-5":"Low · check-in", "d5-6":"Low/Medium · beach/harbor stroll",
  "d6-1":"Low · hotel breakfast", "d6-2":"Low · drive", "d6-3":"Medium · photo walking", "d6-4":"Low · parking logistics", "d6-5":"Low · hotel logistics", "d6-6":"High · waterfront crowds/walking", "d6-7":"Medium/High · hill/photo stop",
  "d7-1":"Medium · wharf walking", "d7-2":"Medium · Pier 33 boarding", "d7-3":"High · Alcatraz slopes/ramps", "d7-4":"Medium · waterfront food stops", "d7-5":"Medium/High · optional only if legs are good",
  "d8-1":"Low · packing", "d8-2":"Medium · optional viewpoint", "d8-3":"Medium · rental return/airport", "d8-4":"Medium · airport walking"
};
...
const reservationSections = [
  ...
  {title:"Hotels", icon:"🏨", fields:[
    field("hotel-ventura-booked","Jul 18 Ventura","BOOKED via Marriott Bonvoy · Four Points by Sheraton Ventura Harbor Resort · confirmation #75176420"),
    field("hotel-ventura-details","Ventura details","1050 Schooner Drive, Ventura, CA · check-in Jul 18 3:00 PM · check-out Jul 19 12:00 PM · guest room with 2 queens"),
...
function renderToday(){
  ...
  $('#today').innerHTML=renderCountdownCard(now, departure, true)+renderMorningBrief(day)+renderWalkingBrief(day)+ dayHeader(day)+ day.stops.map(renderStop).join(''); bindStops($('#today'));
}
    ...
    <section class="countdown-wrap">
      ...
      <article class="card pretrip-card">
        ...
        <div class="prep-grid">
          ...
          <div>🏨 Ventura + HMB + SF hotels booked</div>
      ...
      <article class="card tomorrow-card">
        ...
        <h2>Arrival day: LA icons → Malibu → Ventura</h2>
        <p>Keep LA tight: Walk of Fame, Hollywood Sign, Beverly Hills, Erewhon, then Malibu/PCH to Ventura. No extra LA wandering.</p>
      </article>
    </section>`;
}
function renderCountdownCard(now, departure, compact){
  ...
  return `<article class="card countdown-card ${compact?'compact':''}">
    ...
    <p class="muted">V11 adds walking load by day/stop and fixes Day 1 to Ventura Harbor.</p>
  </article>`;
}
...
function renderDayCard(d){
  ...
  return `<section class="day-card card ${collapsed?'collapsed':''} ${fullyDone?'complete':''}" data-day="${d.day}">
    ...
    <div class="day-body">${renderMorningBrief(d)}${renderWalkingBrief(d)}${renderReminder(d)}${d.stops.map(renderStop).join('')}</div>
  </section>`;
}
...
function renderDetails(){
  ...
  <div class="card vault-summary">
    ...
    <div class="detail-list">
      ...
      <div class="detail"><b>Ventura</b><span>Jul 18 · Four Points Ventura Harbor · Marriott confirmation 75176420</span></div>
...
function renderMorningBrief(d){
  ...
  return `<article class="card morning-brief">
    ...
    <div class="brief-grid">
      ...
      <div><span>Walking</span><b>${escapeHtml((walkingLoads[d.day]?.level || 'TBD') + ' · ' + (walkingLoads[d.day]?.miles || ''))}</b></div>
...
function renderWalkingBrief(d){
  const w = walkingLoads[d.day] || {level:"TBD", miles:"TBD", note:"Walking load not set yet."};
  return `<article class="card walking-card"><div class="walking-head"><div><div class="label">Walking load</div><h2>${escapeHtml(w.level)} · ${escapeHtml(w.miles)}</h2></div><span class="walk-badge">Body cost</span></div><p>${escapeHtml(w.note)}</p></article>`;
}
...
function renderStop(s){
  ...
  return `<article class="stop card ${done?'done':''}" data-id="${s.id}">
    ...
    <div class="stop-main"><div class="time">${s.time}</div><h3>${escapeHtml(s.title)}</h3><p>${escapeHtml(s.desc)}</p>${stopWalking[s.id] ? `<p class="walk-note"><b>Walking:</b> ${escapeHtml(stopWalking[s.id])}</p>` : ""}
